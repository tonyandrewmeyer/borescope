---
title: "Scope and philosophy — borescope"
description: "Why borescope is Kubernetes-only, ships a minimal command set, and leans on exec rather than reimplementing coreutils."
h1: "Scope and philosophy"
subtitle: "What borescope deliberately does — and doesn't — do, and why."
section: explanation
breadcrumb_label: "Scope and philosophy"
on_this_page:
  - { anchor: "k8s-only", label: "Kubernetes only" }
  - { anchor: "minimal", label: "A minimal command set" }
  - { anchor: "exec-first", label: "exec over reimplementation" }
  - { anchor: "grow", label: "Growing on request" }
  - { anchor: "not", label: "What borescope is not" }
see_also:
  - { label: "How borescope works", href: "explanation-architecture.html" }
