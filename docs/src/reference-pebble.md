---
title: "Pebble compatibility: borescope"
description: "Which Pebble versions borescope is tested against, and what to expect from older Pebbles."
h1: "Pebble compatibility"
subtitle: "What Pebble versions borescope supports, by transport."
section: reference
breadcrumb_label: "Pebble compatibility"
on_this_page:
  - { anchor: "supported", label: "Supported versions" }
  - { anchor: "ssh-shimmer", label: "ssh / exec (shimmer) path" }
  - { anchor: "socket", label: "Direct socket path" }
  - { anchor: "checking", label: "Checking what you have" }
see_also:
...
connected to, alongside borescope's own version.
