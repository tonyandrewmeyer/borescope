---
title: "How to connect to a unit — borescope"
description: "Target the right Juju Kubernetes workload container, model, and controller with borescope."
h1: "Connect to a unit"
subtitle: "Point borescope at exactly the workload container you want to debug."
section: howto
breadcrumb_label: "Connect to a unit"
on_this_page:
  - { anchor: "basic", label: "The basic case" }
  - { anchor: "container", label: "Choose a container" }
  - { anchor: "model", label: "Choose a model" }
  - { anchor: "controller", label: "Use a different juju" }
  - { anchor: "what-it-checks", label: "What borescope checks" }
  - { anchor: "errors", label: "Common errors" }
see_also:
  - { label: "Run inside the charm container", href: "howto-here.html" }
...
All of this uses only your Juju model access — never `kubectl` or
