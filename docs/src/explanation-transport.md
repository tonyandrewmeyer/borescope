...
on_this_page:
  ...
  - { anchor: "insight", label: "The key insight" }
  - { anchor: "mode-b", label: "Through the charm container" }
  - { anchor: "mode-a", label: "Direct to the socket" }
  - { anchor: "relay", label: "ssh vs exec relay" }
  - { anchor: "authority", label: "Authority, not privilege" }
see_also:
